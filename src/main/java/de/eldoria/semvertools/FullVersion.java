...
class FullVersion implements SemanticVersion {
    private final VersionCore versionCore;
    private final PreRelease preRelease;
    private final Build build;

    FullVersion(VersionCore versionCore, PreRelease preRelease, Build build) {
    ...
    @Override
    public SemanticVersion withPreRelease(PreRelease preRelease) {
    ...
    @Override
    public SemanticVersion withBuild(Build build) {
